...
![MongoDB](/assets/mongo.png) ![MySQL](/assets/mysql.png)

**Machine Learning**

![Tensorflow](/assets/tensorflow.png) ![Scikit](/assets/scikit.png)
...
<div id="toc"> <!-- both work, toc or user-content-toc -->
  <ul style="list-style: none;">
    <summary>
      ...
      <h2 style="border: 0"><b>FailedHit</b></br><span><sup><sub>Universal Multi-hack</sub></sup></span></h2>
    </summary>
  </ul>
</div>
...
<div id="toc">
  <ul style="list-style: none;">
    <summary>
      <h2 style="border: 0"><b>LuaDisassembler</b></br><span><sup><sub>A disassembler for compiled Lua code in JavaScript</sub></sup></spawn></h2>
    </summary>
  </ul>
</div>
